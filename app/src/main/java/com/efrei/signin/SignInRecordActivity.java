...
import com.efrei.adapter.ListSignInRecordAdapter;
import com.efrei.api.Api;
import com.efrei.app.App;
import com.efrei.bean.ResponseSigninRecord;
import com.efrei.bean.SignIn;
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if(responseSigninRecord.getStatus().equals(Constant.SUCCESS)){
                            ...
                            if(datas==null || datas.size()<=0){
                                Toast.makeText(SignInRecordActivity.this, getResources().getString(R.string.signInRecord_noRecord_message),Toast.LENGTH_SHORT).show();
                            }else{
                                adapter.notifyDataSetChanged();
                            }
                        }else{
                            Toast.makeText(SignInRecordActivity.this, getResources().getString(R.string.signInRecord_wrong_message),Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                });
                ...
                try {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(SignInRecordActivity.this, getResources().getString(R.string.signInRecord_refresh_message),Toast.LENGTH_SHORT).show();
                        }
                    });
